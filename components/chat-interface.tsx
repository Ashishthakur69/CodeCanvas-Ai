                  ...
                  <div className="mt-2 flex justify-end space-x-2">
                    {message.code && (
                       <Button
                        ...
                        onClick={() => handleDownloadCode(message.code!, 'ai_generated_code.html')}
                      >
      ...
      <div className="border-t border-border p-4">
        ...
        <div className="mb-3">
          ...
          <select
            ...
            disabled={isGenerating}
          >
            <option value="react">React + Tailwind (Default)</option>
            <option value="nextjs">Next.js Component</option>
            <option value="vue">Vue 3 + Tailwind</option>
            <option value="html">HTML/CSS/Vanilla JS</option>
          </select>
        </div>
